...
urlpatterns = [
    ...
    path('ICCBStickets', include('ICCBStickets.urls')),
    
    
    
    
    path('',views.home_view,name=''),
    path('logout', LogoutView.as_view(template_name='papers/logout.html'),name='logout'),
    ...
    path('adminlogin', LoginView.as_view(template_name='papers/adminlogin.html'),name='adminlogin'),
